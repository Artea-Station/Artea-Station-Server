...
/obj/structure/closet/body_bag/environmental/proc/refresh_air()
	...
	air_contents.gas[GAS_OXYGEN] = (ONE_ATMOSPHERE*50)/(R_IDEAL_GAS_EQUATION*T20C) * O2STANDARD
	air_contents.gas[GAS_NITROGEN] = (ONE_ATMOSPHERE*50)/(R_IDEAL_GAS_EQUATION*T20C) * N2STANDARD
...
/obj/structure/closet/body_bag/environmental/prisoner/syndicate
	...
	desc = "An alteration of Artea's environmental protection bag which has been used in several high-profile kidnappings. Designed to keep a victim unconscious, alive, and secured during transport."
	icon = 'icons/obj/bodybag.dmi'
