...
/obj/structure/falsewall
	...
	canSmoothWith = list*+(SMOOTH_GROUP_WALLS, SMOOTH_GROUP_SHUTTERS_BLASTDOORS, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_WINDOW_FULLTILE)
...
/obj/structure/falsewall/titanium
	...
	canSmoothWith = list*+(SMOOTH_GROUP_WALLS, SMOOTH_GROUP_SHUTTERS_BLASTDOORS, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_WINDOW_FULLTILE, SMOOTH_GROUP_SHUTTLE_PARTS)
