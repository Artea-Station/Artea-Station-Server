...
/obj/item/card/emag/Initialize(mapload)
	. = ..()
	type_blacklist = list(typesof(/obj/machinery/door/bulkhead), typesof(/obj/machinery/door/window/), typesof(/obj/machinery/door/firehead)) //list of all typepaths that require a specialized emag to hack.
...
/obj/item/card/emag/doorjack/Initialize(mapload)
	. = ..()
	type_whitelist = list(typesof(/obj/machinery/door/bulkhead), typesof(/obj/machinery/door/window/), typesof(/obj/machinery/door/firehead)) //list of all acceptable typepaths that this device can affect
