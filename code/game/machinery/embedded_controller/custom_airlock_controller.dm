...
MAPPING_DIRECTIONAL_HELPERS(/obj/machinery/embedded_controller/radio/airlock_controller/autoset, 24)
...
/obj/machinery/embedded_controller/radio/airlock_controller/autoset/hallway
	name = "autoset hallway airlock controller"

MAPPING_DIRECTIONAL_HELPERS(/obj/machinery/embedded_controller/radio/airlock_controller/autoset/hallway, 24)

/obj/machinery/embedded_controller/radio/airlock_controller/Initialize(mapload)
	. = ..()
	var/datum/computer/file/embedded_program/airlock_controller/controller_program = program
	controller_program.is_hallway = TRUE
