/obj/item/newspaper
	name = "newspaper"
	desc = "An issue of The Griffon, the newspaper circulating aboard Artea Space Stations."
...
/obj/item/newspaper/attack_self(mob/user)
	...
	switch(screen)
		if(0) //Cover
			...
			dat+="<DIV ALIGN='center'><FONT SIZE=2>Artea-standard newspaper, for use on Artea? Space Facilities</FONT></div><HR>"
