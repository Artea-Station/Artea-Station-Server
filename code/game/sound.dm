 ...
 * ignored_mobs - What mobs shouldn't recieve this sound? Can be a list.
 * play_directly_for_target - Makes the source have it's own playsound_local which ignores pressure and reverb. Good for sounds like a radio inside a hardsuit while the source could potentially be in space.
 */
/proc/playsound(atom/source, soundin, vol as num, vary, extrarange as num, falloff_exponent = SOUND_FALLOFF_EXPONENT, frequency = null, channel = 0, pressure_affected = TRUE, ignore_walls = TRUE, falloff_distance = SOUND_DEFAULT_FALLOFF_DISTANCE, use_reverb = TRUE, ignored_mobs = null, play_directly_for_target = FALSE)
	if(isarea(source))
	...
	if(ignored_mobs)
		listeners -= ignored_mobs
	if(play_directly_for_target && ismob(source))
		listeners -= source
		var/mob/mob = source
		mob.playsound_local(turf_source, soundin, vol, vary, frequency, falloff_exponent, channel, FALSE, S, maxdistance, falloff_distance, 1, FALSE)
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if (SFX_BODYFALL)
				soundin = pick('sound/effects/bodyfall1.ogg',
					'sound/effects/bodyfall2.ogg',
					'sound/effects/bodyfall3.ogg',
					'sound/effects/bodyfall4.ogg',
				)
			if (SFX_PUNCH)
				soundin = pick('sound/weapons/punch1.ogg',
					'sound/weapons/punch2.ogg',
					'sound/weapons/punch3.ogg',
					'sound/weapons/punch4.ogg',
				)
			if (SFX_CLOWN_STEP)
				soundin = pick('sound/effects/clownstep1.ogg',
					'sound/effects/clownstep2.ogg',
				)
			if (SFX_SUIT_STEP)
				soundin = pick('sound/effects/suitstep1.ogg',
					'sound/effects/suitstep2.ogg',
				)
			if (SFX_SWING_HIT)
				soundin = pick('sound/weapons/genhit1.ogg',
					'sound/weapons/genhit2.ogg',
					'sound/weapons/genhit3.ogg',
				)
			if (SFX_HISS)
				soundin = pick('sound/voice/hiss1.ogg',
					'sound/voice/hiss2.ogg',
					'sound/voice/hiss3.ogg',
					'sound/voice/hiss4.ogg',
				)
			if (SFX_PAGE_TURN)
				soundin = pick('sound/effects/pageturn1.ogg',
					'sound/effects/pageturn2.ogg',
					'sound/effects/pageturn3.ogg',
				)
			if (SFX_RICOCHET)
				soundin = pick( 'sound/weapons/effects/ric1.ogg',
			...
			if (SFX_TERMINAL_TYPE)
				soundin = pick('sound/machines/terminal_button01.ogg',
			...
			if("goose")
				soundin = pick('sound/creatures/goose1.ogg',
			...
			if(SFX_SM_CALM)
				soundin = pick('sound/machines/sm/accent/normal/1.ogg',
			...
			if(SFX_SM_DELAM)
				soundin = pick('sound/machines/sm/accent/delam/1.ogg',
			...
			if(SFX_CRUNCHY_BUSH_WHACK)
				soundin = pick('sound/effects/crunchybushwhack1.ogg',
					'sound/effects/crunchybushwhack2.ogg',
					'sound/effects/crunchybushwhack3.ogg',
				)
			if(SFX_TREE_CHOP)
				soundin = pick('sound/effects/treechop1.ogg',
					'sound/effects/treechop2.ogg',
					'sound/effects/treechop3.ogg',
				)
			if(SFX_ROCK_TAP)
				soundin = pick('sound/effects/rocktap1.ogg',
					'sound/effects/rocktap2.ogg',
					'sound/effects/rocktap3.ogg',
				)
			if(SFX_SWITCH)
				soundin = pick('sound/machines/switch1.ogg',
					'sound/machines/switch2.ogg',
					'sound/machines/switch3.ogg',
				)
			if(SFX_KEYBOARD)
				soundin = pick(
					'sound/machines/keypress1.ogg',
					'sound/machines/keypress2.ogg',
					'sound/machines/keypress3.ogg',
					'sound/machines/keypress4.ogg',
					'sound/machines/keypress5.ogg',
				)
			if(SFX_PDA)
