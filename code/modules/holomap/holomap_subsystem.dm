...
/datum/controller/subsystem/holomaps/proc/generate_default_holomap_legend()
	for(var/department_color in GLOB.holomap_color_to_name)
		var/image/marker_icon = image('icons/obj/machines/holomap/8x8.dmi', "area_legend")
		var/icon/marker_color_overlay = icon('icons/obj/machines/holomap/8x8.dmi', "area_legend")
	...
	for(var/x = 1 to world.maxx)
		for(var/y = 1 to world.maxy)
			...
			if(istype(z_transition_obj, /obj/structure/stairs))
				...
				image_to_use = image('icons/obj/machines/holomap/8x8.dmi', "stairs_down")
