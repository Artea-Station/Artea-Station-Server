...
/datum/supply_pack/security/ammo
	name = "Ammo Crate"
	desc = "Contains three boxes of beanbag shotgun shells, three boxes of rubbershot shotgun shells and one of each special .38 speedloarders."
...
/datum/supply_pack/security/forensics
	...
	desc = "Stay hot on the criminal's heels with Artea's Detective Essentials(tm). Contains a forensics scanner, six evidence bags, camera, tape recorder, white crayon, and of course, a fedora."
...
/datum/supply_pack/security/securityclothes
	...
	desc = "Contains appropriate outfits for the station's private security force. Contains outfits for the Warden, Head of Security, and two Security Officers. Each outfit comes with a rank-appropriate jumpsuit, suit, and beret."
	cost = CARGO_CRATE_VALUE * 3
