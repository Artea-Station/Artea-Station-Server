...
/mob/dead/new_player/proc/poll_player_irv(datum/poll_question/poll)
	...
	<style>
		...
		#sortable li { min-height: 1em; margin: 0px 1px 1px 1px; padding: 1px; border: 1px solid black; background-color: white; cursor:move;}
		#sortable .sortable-placeholder-highlight { min-height: 1em; margin: 0 2px 2px 2px; padding: 2px; border: 1px dotted blue; background-color: GhostWhite; }
