...
/obj/structure/biohazard_blob/structure/core
	name = "glowing core"
	icon = 'icons/effects/moldies/blob_core.dmi'
...
/obj/structure/biohazard_blob/resin
	...
	icon = 'icons/effects/moldies/blob_resin.dmi'
...
/obj/structure/biohazard_blob/structure/bulb
	name = "empty bulb"
	icon = 'icons/effects/moldies/blob_bulb.dmi'
...
/obj/structure/biohazard_blob/structure/conditioner
	...
	density = FALSE
	icon = 'icons/effects/moldies/blob_spawner.dmi'
