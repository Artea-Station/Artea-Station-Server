...
/proc/create_separatist_nation(datum/job_department/department, announcement = FALSE, dangerous = FALSE, message_admins = TRUE)
	...
	if(!department)
		...
		department = pick(list(/datum/job_department/assistant, /datum/job_department/medical, /datum/job_department/engineering, /datum/job_department/cargo, /datum/job_department/service, /datum/job_department/security, /datum/job_department/pathfinders) - independent_departments)
		if(!department)
			if(message_admins)
