...
/mob/proc/send_to_cryo(with_paper = FALSE)
	...
	if(with_paper)
		...
		cryo_paper.add_raw_text("Our sincerest apologies, [name][job ? ", [job]," : ""] had to be sent back into Cryogenic Storage for medical reasons.<br><br>Sincerely,<br><i>Artea Logicstics Central Office</i>")
