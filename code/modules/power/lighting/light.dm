...
/obj/machinery/light
	...
	///Basecolor of the nightshift light. Autogenerated with a slightly warmer color if left unset.
	var/nightshift_light_color = null
...
/obj/machinery/light/proc/update(trigger = TRUE)
	...
	if(on)
		...
		if (length(local_area?.active_alarms[ALARM_FIRE]))
			...
			power_set -= power_set * NIGHTSHIFT_LIGHT_MODIFIER
