...
/obj/item/clothing/under/artea
	icon = 'icons/mob/inhands/clothing/artea_core_clothes.dmi' // Wrong path, I know, I can't be assed.
...
// Pathfinders
ARTEA_CLOTHING(pathfinder, "pathfinder", "pathfinder_skirt", "Pathfinder Uniform")
