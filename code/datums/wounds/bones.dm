...
/datum/wound/blunt/bone/set_limb(obj/item/bodypart/new_value)
	...
	if (new_value)
		RegisterSignal(new_value, list(COMSIG_BODYPART_GAUZED, COMSIG_BODYPART_GAUZE_DESTROYED), PROC_REF(update_inefficiencies))
...
/datum/wound/blunt/bone/get_examine_description(mob/user)
