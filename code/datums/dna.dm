...
/datum/dna
	...
	var/emote_voice_type
	///If non-null, try to use this instead for normal speech.
	var/say_voice_type
	///If non-null, try to use this instead for *me emotes.
	var/me_sound_type
...
/datum/dna/proc/transfer_identity(mob/living/carbon/destination, transfer_SE = FALSE, transfer_species = TRUE)
	...
	destination.dna.emote_voice_type = emote_voice_type
	if(transfer_SE)
...
/datum/dna/proc/copy_dna(datum/dna/new_dna)
	...
	new_dna.emote_voice_type = emote_voice_type
