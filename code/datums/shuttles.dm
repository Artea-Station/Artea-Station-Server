...
/datum/map_template/shuttle/emergency/asteroid
	...
	description = "A respectable mid-sized shuttle that first saw service shuttling Artea crew to and from their asteroid belt embedded facilities."
...
/datum/map_template/shuttle/emergency/discoinferno
	suffix = "discoinferno"
	name = "Disco Inferno"
	description = "The glorious results of centuries of plasma research done by Artea employees. This is the reason why you are here. Get on and dance like you're on fire, burn baby burn!"
...
/datum/map_template/shuttle/emergency/goon
	suffix = "goon"
	name = "NES Port"
	description = "The Artea Emergency Shuttle Port(AES Port for short) is a shuttle used at other less known Artea facilities and has a more open inside for larger crowds, but fewer onboard shuttle facilities."
	credit_cost = CARGO_CRATE_VALUE

/datum/map_template/shuttle/emergency/rollerdome
	suffix = "rollerdome"
	name = "Uncle Pete's Rollerdome"
	description = "Developed by a member of Artea's R&D crew that claims to have travelled from the year 2028. \
...
/datum/map_template/shuttle/cargo/bearcat
	suffix = "bearcat"
