...
#define CARTRIDGE_LIST_CHEM_DISPENSER list( \
	...
	/datum/reagent/bromine = /obj/item/reagent_containers/chem_cartridge/small, \
...
#define CARTRIDGE_LIST_DRINKS list( \
		...
		/datum/reagent/consumable/pwr_game = /obj/item/reagent_containers/chem_cartridge/medium, \
