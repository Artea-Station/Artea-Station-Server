...
/// The baseline unit for cargo crates. Adjusting this will change the cost of all in-game shuttles, crate export values, and all supply pack import values, as they use this as their unit of measurement.
