...
#define TURFS_CAN_SHARE(T1, T2) (LAZYACCESS(T2.get_atmos_adjacent_turfs(), T1) || LAZYLEN(T1.get_atmos_adjacent_turfs() & T2.get_atmos_adjacent_turfs()))
...
#define TURF_SHARES(T) (LAZYLEN(T.get_atmos_adjacent_turfs()))
