...
#define MAX_HIGH_PRESSURE_DAMAGE 4 // The amount of damage someone takes when in a high pressure area.
...
#define ATMOSTANK_PLASMA        list(GAS_PLASMA = 70000) // Used in the reactor. You need shittons to do literally anything with power.
